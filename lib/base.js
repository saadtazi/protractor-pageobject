...
var Base = module.exports = Klass.extend({
  ...
  element: function(elName) {
    // protractor element
    return this.dv.element(this.getElementSelector(elName));
  },
  elements: function(elName) {
    // no alias set by protactor
    return this.dv.element.all(this.getElementSelector(elName));
  },
  ...
  setFieldValue: function(el, value) {
    ...
    if (this.components && this.components[el]) {
